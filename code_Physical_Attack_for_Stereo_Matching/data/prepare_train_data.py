...
parser.add_argument("--dataset_dir",type=str, default="/home/zjc/kitti/",
                    help='path to original dataset')
parser.add_argument("--dataset-format", type=str, default='kitti')
...
parser.add_argument("--dump-root", type=str, default="/home/zjc/stereo_attack/stereo_attack/flowattack-master/path/to/resulting", help="Where to dump the data")
